                ...
                <div class="row">
                  ...
                  <div class="col-md-3 form-group">
                    <label><strong>First Name</strong>
                      <input class="form-control" id="firstName" name="firstName" type="text" placeholder="Forname" required requiredMessage="Please enter your first name" pattern=".{1,45}">
          				  </label>
                  </div>
                  <div class="col-md-3 form-group">
                    <label><strong>Second Name</strong>
                      <input class="form-control" id="secondName" name="secondName" type="text" placeholder="Surname" required requiredMessage="Please enter your second name" pattern=".{1,45}">
          				  </label>
                  </div>
                  <div class="col-md-3 form-group"></div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-3 form-group">
                    <label><strong>Father's Name</strong>
                      <input class="form-control" id="fathersName" name="fathersName" type="text" placeholder="Father" required requiredMessage="Please enter your father's name" pattern=".{1,45}">
          				  </label>
                  </div>
                  <div class="col-md-3 form-group">
                    <label><strong>Mother's Name</strong>
                      <input class="form-control" id="mothersName" name="mothersName" type="text" placeholder="Mother" required requiredMessage="Please enter your mother's name" pattern=".{1,45}">
          				  </label>
                  </div>
                  <div class="col-md-3 form-group"></div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-3 form-group">
                    <label><strong>Place of Birth</strong>
                      <input class="form-control" id="placeOfBirth" name="placeOfBirth" type="text" placeholder="Birthplace" required requiredMessage="Please enter your place birth" pattern=".{1,45}">
          				  </label>
                  </div>
                  <div class="col-md-3 form-group"></div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-3 form-group">
                    <label><strong>Home Address</strong>
                      <input class="form-control" id="homeAddress" name="homeAddress" type="text" placeholder="Home" required requiredMessage="Please enter your home address" pattern=".{1,45}">
          					</label>
                  </div>
                  <div class="col-md-3 form-group">
                ...
                <div class="row">
                  ...
                  <div class="col-md-3 form-group">
                    <label><strong>ID Number</strong>
          						<input class="form-control" id="IDNumber" name="IDNumber" type="text" placeholder="ID" required requiredMessage="Please enter your ID number" pattern=".{1,45}">
          					</label>
          				</div>
          				<div class="col-md-3 form-group">
                    <label><strong>Phone Number</strong>
          						<input class="form-control" id="phone" name="phone" type="tel" placeholder="Phone" required requiredMessage="Please enter your phone number" pattern=".{1,45}">
          					</label>
          				</div>
                  <div class="col-md-3 form-group"></div>
                </div>
